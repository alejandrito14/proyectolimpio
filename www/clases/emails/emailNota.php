            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
                <tr>
                    <td align="center" valign="top" style="padding: 15px 0;" class="logo">
                        <a href="https://www.todoamayoreo.com" target="_blank">
                            <img alt="Logo" src="https://www.todoamayoreo.com/images/logoprin.png" width="224" height="60" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0">
                        </a>
                    </td>
                </tr>
            </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 47%;" align="right">
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #7ca230; font-size: 16px; font-weight: bold;">TOTAL $'.$this->total.'</td>
                                                    </tr>
                ...
                <tr>
                    <td align="center" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                       Telefono: 9612521362 -
                        ...
                        <a href="https://www.todoamayoreo.com" target="_blank" style="color: #666666; text-decoration: none;">Copyright © 2019, Todo a mayoreo</a>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
