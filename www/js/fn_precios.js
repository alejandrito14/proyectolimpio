function Cambiarprincipal() {

	if ($("#v_principal").is(':checked')) {
...
function Guardarprecio(form,regresar,donde,idmenumodulo)
{
	...
	{			
		...
		setTimeout(function(){
				  $.ajax({
					url:'catalogos/precios/ga_precio.php', //Url a donde la enviaremos
