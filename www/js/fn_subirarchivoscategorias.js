...
var vfile;
function fileUploadCategoria(event){

 
    //notify user about the file upload status

    var url='catalogos/categoriasproducto/subirarchivocategoria.php',
    ...
    if (contar>0) {      
      ...
      var idcategoriasproducto=$("#idcategoriasproducto").val();
    ...
    for (var i = 0; i < files.length; i++) {
        var file = files[i];
            ...
            data.append('idcategoriasproducto',idcategoriasproducto);
          ...
          xhr.onprogress = function(e) {
            ...
            xhr.onload = function () {
              ...
              if(response==1){
               ...
               showAttachedFiles1(idcategoriasproducto);
                setTimeout('cerrarModal1('+idcategoriasproducto+')',3000);
              document.getElementById("demoimg1").value = "";
...
function cerrarModal1(idcategoriasproducto) {


       $("#cargando").modal('hide');
       // showAttachedFiles1(idproductos,idempresas);

}

function showAttachedFiles1(idcategoriasproducto) {
    
    var datos="idcategoriasproducto="+idcategoriasproducto;
    $("#vfileNames").html("");
        $.ajax({
     type: 'post',
        url: 'catalogos/categoriasproducto/obtenerimagenescategorias.php',
        data:datos,
        dataType: "json",
              ...
              var html=`<table class="table">
                ...
                if (vattachedFiles.length>0) {
                  ...
                  for (var i =0;i < vattachedFiles.length; i++) {
                      ...
                      html+=`<tr>
                      <th scope="row">
                      <img style="width:50px;height:50px;" src="catalogos/categoriasproducto/imagenes/`+vattachedFiles[i].imagen+`" />
                      </th>
                     
                      <td><span style="cursor:pointer" onclick="deleteArchivo1(`+ vattachedFiles[i].idcategoriasimagenes +`,`+vattachedFiles[i].idcategorias+`);" class="label label-success" style="background-color:#089908;font-size:16px;"><strong>x</strong></span></td>
                    </tr>`;
                  }
...
function deleteArchivo1(idcategoriasimagenes,idcategorias) {

  var datos='idcategoriasimagenes='+idcategoriasimagenes+"&idcategorias="+idcategorias;
          ...
          if (r == true) {
               ...
               setTimeout(function () {
                    $.ajax({
                      url: 'catalogos/categoriasproducto/eliminarimagen.php', //Url a donde la enviaremos
                      ...
                      success: function (msj) {
                        ...
                        showAttachedFiles1(idcategorias);
                      }
                    });
                }, 100);
