...
if(isset($_GET['ac']))
{
 ...
 if($total==0)
        ...
        <?php
            ...
            <?php do{?>
				<tr> 
    				...
    				<td><input type="image" src="images/icn_edit.png" title="EDITAR" onclick="aparecermodulos('administrador/fc_perfiles.php?id=<?php echo $rows['idusuarios'];?>','main')">
	...
	$pag->pagina="administrador/li_modulos.php";
