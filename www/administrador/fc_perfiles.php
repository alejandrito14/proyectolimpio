...
<form id="alta_perfil" method="post" action="">
	<div class="card">
		...
		<div class="card-header">
			...
			<button type="button" onClick="aparecermodulos('administrador/vi_perfiles.php','main');" class="btn btn-primary" style="float: right;"><i class="mdi mdi-arrow-left-box"></i>LISTADO DE PERFILES</button>
